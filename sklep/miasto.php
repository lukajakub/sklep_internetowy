...
include "navbar.php";
    ...
    <br><br>
      <div style="padding-left:20px; text-align: center;">
        <h1>Współpraca - Miasto Siedlce</h1>
        <br><br>
        <img src="stawy.jpg" class="img-thumbnail" alt="stawy" style="height: 500px; width=300px;">
      </div>
      <br><br><br>
      <p style="margin-left: 100px; font-size: 18px;">Co roku na początku maja wraz ze sklepem wędkarskim ,,Szczupak'' prowadzone są zarybiania na naszych stawach.</p>
