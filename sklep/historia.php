...
include "navbar.php";
    ...
    <br><br>
      <div style="padding-left:20px; text-align: center;">
        <h1>Historia</h1>
        <br><br>
        <img src="historia.jpg" class="img-thumbnail" alt="...">
      </div>
      <br><br><br>
      <p style="margin-left: 100px; font-size: 18px;">Sklep rozpoczął swoją działalność w styczniu 2022 roku. Sklep został stworzony dla osób chcących aktywnie spędzić wolny czas.</p>
