...
include "navbar.php";
    ...
    <br><br>
      <div style="padding-left:20px; text-align: center;">
        <h1>Współpraca - Daiwa</h1>
        <br><br>
        <img src="daiwa.jpg" class="img-thumbnail" alt="stawy" style="height: 500px; width=300px;">
      </div>
      <br><br><br>
      <p style="margin-left: 100px; font-size: 18px;">Wspieramy również dziecięce szkółki wędkarskie i wiele inicjatyw mających na celu szeroko pojęte propagowanie wędkarstwa jako formy spędzania czasu w sposób przyjemny, sportowy i zdrowy.</p>
